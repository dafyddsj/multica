---
title: Projects
description: Time-boxed work that groups related issues under a shared goal, plan, and execution context.
---

import { Callout } from "fumadocs-ui/components/callout";

A project is time-boxed work that takes multiple [issues](/issues) to finish. A sprint, a migration, or a feature you ship in stages belongs here.

A product, service, or program that outlives any one of those efforts belongs on an [initiative](/initiatives). Work a single issue can describe does not need a project.

Projects fit a group of work that shares a goal, needs its progress tracked together, or needs shared repositories and working directories.
...
- [Initiatives](/initiatives) — durable product, service, or program that owns projects.
