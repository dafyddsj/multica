      ...
      runtimes: {
        ...
        cards: [
          ...
          },
          {
            ...
            description:
              "Multica는 Amp, Antigravity, Claude Code, CodeBuddy, Codex, Copilot, Cursor, DeepSeek Harness, DevEco Code, Dim, Goose, Grok, Hermes, Kimi, Kiro CLI, Oh-My-Pi, OpenClaw, OpenCode, Pi, Qoder, Qoder CN, Qwen Code, QwenPaw, Reasonix, Trae CLI 등 25개 지원 도구를 스캔해 이미 설치된 것을 런타임으로 자동 등록합니다.",
          },
        ],
      },
    },
