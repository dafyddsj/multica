      ...
      runtimes: {
        ...
        cards: [
          ...
          },
          {
            ...
            description:
              "Multica는 Amp, Antigravity, Claude Code, CodeBuddy, Codex, Copilot, Cursor, DeepSeek Harness, Devin, DevEco Code, Dim, Goose, Grok, Hermes, Kimi, Kiro CLI, Oh-My-Pi, OpenClaw, OpenCode, Pi, Qoder, Qoder CN, Qwen Code, QwenPaw, Reasonix, Trae CLI 등 26개 지원 도구를 스캔해 이미 설치된 것을 런타임으로 자동 등록합니다.",
          },
        ],
      },
    },
      ...
      entries: [
        {
          version: "0.4.41",
          date: "2026-09-07",
          title: "새로워진 사이드바, 대규모 워크스페이스에서 더 빠른 검색, Autopilot 수동 실행, 더 간결한 명령줄 출력",
          changes: [],
          features: [
