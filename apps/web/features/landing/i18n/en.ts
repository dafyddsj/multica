...
export function createEnDict(allowSignup: boolean): LandingDict {
  ...
  features: {
    ...
    runtimes: {
      ...
      description:
        "Local daemons and cloud runtimes, managed from a single panel. Real-time monitoring of online/offline status, usage charts, and activity heatmaps. Auto-detects 25 supported coding tools on your machine.",
      cards: [
        {
        ...
        },
        {
          ...
          description:
            "Multica scans for 25 supported coding tools \u2014 Amp, Antigravity, Claude Code, CodeBuddy, Codex, Copilot, Cursor, DeepSeek Harness, DevEco Code, Dim, Goose, Grok, Hermes, Kimi, Kiro CLI, Oh-My-Pi, OpenClaw, OpenCode, Pi, Qoder, Qoder CN, Qwen Code, QwenPaw, Reasonix, and Trae CLI \u2014 and registers a runtime for each one it finds.",
        },
      ],
    },
  },
