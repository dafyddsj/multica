  ...
  howItWorks: {
    ...
    steps: [
      ...
      },
      {
        ...
        description:
          "Run multica setup \u2014 it walks you through OAuth, starts the daemon, and scans for the 26 supported coding tools (Amp, Antigravity, Claude Code, CodeBuddy, Codex, Copilot, Cursor, DeepSeek Harness, Devin, DevEco Code, Dim, Goose, Grok, Hermes, Kimi, Kiro CLI, Oh-My-Pi, OpenClaw, OpenCode, Pi, Qoder, Qoder CN, Qwen Code, QwenPaw, Reasonix, Trae CLI). Whichever ones you already have installed get registered as runtimes automatically.",
      },
      {
