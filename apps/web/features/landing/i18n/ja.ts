      ...
      runtimes: {
        ...
        cards: [
          ...
          },
          {
            title: "初回起動時に自動検出",
            description:
              "Multica は Amp、Antigravity、Claude Code、CodeBuddy、Codex、Copilot、Cursor、DeepSeek Harness、Devin、DevEco Code、Dim、Goose、Grok、Hermes、Kimi、Kiro CLI、Oh-My-Pi、OpenClaw、OpenCode、Pi、Qoder、Qoder CN、Qwen Code、QwenPaw、Reasonix、Trae CLI という26種類の対応ツールをスキャンし、見つかったものをそれぞれランタイムとして登録します。",
          },
        ],
      },
    },
    howItWorks: {
      ...
      steps: [
        ...
        },
        {
          ...
          description:
            "multica setup を実行すると、OAuth の手順を案内し、デーモンを起動し、26種類の対応コーディングツール(Amp、Antigravity、Claude Code、CodeBuddy、Codex、Copilot、Cursor、DeepSeek Harness、Devin、DevEco Code、Dim、Goose、Grok、Hermes、Kimi、Kiro CLI、Oh-My-Pi、OpenClaw、OpenCode、Pi、Qoder、Qoder CN、Qwen Code、QwenPaw、Reasonix、Trae CLI)をスキャンします。すでにインストール済みのものは、自動的にランタイムとして登録されます。",
        },
        {
          title: "最初のエージェントを作成",
          description:
      ...
      items: [
        {
          ...
          answer:
            "Multica は、Amp、Antigravity、Claude Code、CodeBuddy、Codex、Copilot、Cursor、DeepSeek Harness、Devin、DevEco Code、Dim、Goose、Grok、Hermes、Kimi、Kiro CLI、Oh-My-Pi、OpenClaw、OpenCode、Pi、Qoder、Qoder CN、Qwen Code、QwenPaw、Reasonix、Trae CLI の26種類のコーディングツールに標準対応しています。デーモンが、すでにインストール済みの CLI を自動検出し、それぞれをランタイムとして登録します。オープンソースなので、独自のバックエンドを追加することもできます。",
        },
        {
      ...
      entries: [
        {
          version: "0.4.41",
          date: "2026-09-07",
          title: "狭くなった Inbox、入れ子リストのショートカット、分かりやすくなった Codex の compaction エラー",
          changes: [],
          features: [],
          improvements: [
        ...
        },
        {
          version: "0.4.40",
          date: "2026-09-04",
          title: "アップデート中も安定したタスク起動と、浅いキャッシュからのチェックアウト",
          changes: [],
          features: [],
          improvements: [],
          fixes: [
        ...
        },
        {
          version: "0.4.39",
          date: "2026-09-03",
          title: "タブ切り替えのショートカット、Autopilot の権限、リーダーへの返信",
          changes: [],
          features: [
          ...
          fixes: [
            ...
            "長いタスクの識別子が、一覧や表でタイトルを隠さなくなりました。",
