      ...
      runtimes: {
        ...
        cards: [
          ...
          },
          {
            title: "初回起動時に自動検出",
            description:
              "Multica は Amp、Antigravity、Claude Code、CodeBuddy、Codex、Copilot、Cursor、DeepSeek Harness、Devin、DevEco Code、Dim、Grok、Hermes、Kimi、Kiro CLI、Oh-My-Pi、OpenClaw、OpenCode、Pi、Qoder、Qoder CN、Qwen Code、QwenPaw、Reasonix、Trae CLI という25種類の対応ツールをスキャンし、見つかったものをそれぞれランタイムとして登録します。",
          },
        ],
      },
    },
