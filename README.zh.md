...
汇报、卡住了主动说，做完交回来给你审。可自部署，支持 27 种智能体 CLI，不绑定任何厂商。
...
- **[27 种智能体 CLI](#运行时) →** Claude Code、Codex、Cursor、Copilot、Kimi、OpenCode、Amp、Devin、Goose 等等。
...
| 智能体运行时 | 本地守护进程拉起上面 27 种智能体 CLI 中的任意一个 |
