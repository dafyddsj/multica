...
// the consuming hooks.
//
// `archived` and `paused` are lifecycle overrides, not runtime colors.
// They are derived BEFORE runtime health in deriveAgentPresenceDetail so
// a leftover online runtime never reads as live. They are intentionally
// NOT in availabilityOrder (those chips stay runtime-only).
export type AgentAvailability =
  ...
  | "paused" // ⏸ agent.paused_at set — hold, keeps real workload
  | "archived"; // ⚫ agent.archived_at set — retired, wins over pause and runtime
