...
- `apps/docs/content/docs/environment-variables.mdx` and the zh/ko/ja siblings: `MULTICA_AMP_PATH`, `MULTICA_AMP_MODEL`, `MULTICA_AMP_ARGS`. Locale env pages already drift (EN names Dim, zh/ko/ja do not). Add Amp to all four.
